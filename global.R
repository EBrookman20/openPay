...
## for Emma's tab
#get data
Emmapayment <- read.csv("~/Github/openPay/data/Open_Payment_south_dakota_2013-21.csv")
...
Emmapayment2 <- subset(Emmapayment2, nature_of_payment_or_transfer_of_value != "")
...
levels(Emmapayment2$nature_of_payment_or_transfer_of_value)

levels(Emmapayment2$nature_of_payment_or_transfer_of_value) <- c('Charitable Contribution', 'Compensation - Services', 
                                                                 'Compensation - Faculty', 'Compensation - NonCert Educational', 'Compensation - Cert Educational', 
                                                                 'Consulting Fee', 'Investment Interest', 'Debt Forgiveness','Education', 'Entertainment', 'Food and Beverage', 
                                                                 'Gift', 'Grant', 'Honoraria', 'Royalty/License', 'Travel/Lodging')
